  ...
  _createClass(BucketAPI, [{
    ...
    value: function add(key, meta, callback) {
      ...
      return _bluebird2.default.resolve(_context2.default.get().then(function (context) {
        return Promise.resolve(_this2._pipeline.add(context, key, meta));
      })).nodeify(callback);
    }
    ...
    value: function set(key, create, callback) {
      ...
      return _bluebird2.default.resolve(_context2.default.get().then(function (context) {
        return Promise.resolve(_this3._pipeline.set(context, key, create));
      })).nodeify(callback);
    }
    ...
    value: function get(key, callback) {
      ...
      return _bluebird2.default.resolve(_context2.default.get().then(function (context) {
        return Promise.resolve(_this4._pipeline.get(context, key));
      })).nodeify(callback);
    }
    ...
    value: function remove(key, callback) {
      ...
      return _bluebird2.default.resolve(_context2.default.get().then(function (context) {
        return Promise.resolve(_this5._pipeline.remove(context, key));
      })).nodeify(callback);
    }
    ...
    value: function getAll(callback) {
      ...
      return _bluebird2.default.resolve(_context2.default.get().then(function (context) {
        return Promise.resolve(_this6._pipeline.getAll(context));
      })).nodeify(callback);
    }
    ...
    value: function each(fn, callback) {
      ...
      return _bluebird2.default.resolve().then(function () {
        return _context2.default.get().then(function (context) {
          return Promise.resolve(_this7._pipeline.each(context, fn));
        });
      }).nodeify(callback);
    }
    ...
    value: function saveMeta(meta, key, callback) {
      ...
      return _bluebird2.default.resolve(_context2.default.get().then(function (context) {
        return Promise.resolve(_this8._pipeline.saveMeta(context, meta, key));
      })).nodeify(callback);
    }
  }]);
