...
var _dataPipeline = require('@hoist/data-pipeline');

var _dataPipeline2 = _interopRequireDefault(_dataPipeline);
...
var DataAPI = function (_BaseAPI) {
  ...
  function DataAPI(type) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DataAPI).call(this));

    if (type) {
      _this.setType(type);
    }
    _this._pipeline = new _dataPipeline2.default();
    return _this;
  }
  ...
  _createClass(DataAPI, [{
    ...
    value: function _verify() {
      ...
      return Promise.resolve().then(function () {
        if (!_this2._type) {
          throw new _errors2.default.data.request.InvalidError('you need to specify a type for the retrieval, call #setType([typename]) first');
        }
      });
    }
    ...
    value: function find(query, callback) {
      ...
      return _bluebird2.default.resolve(this._verify().then(function () {
        return _this3._pipeline.find(_this3._type, query || {});
      })).nodeify(callback);
    }
    ...
    value: function findById(id, callback) {
      ...
      return _bluebird2.default.resolve(Promise.resolve().then(function () {
        if (!id) {
          throw new _errors2.default.data.request.InvalidError('you need to specify an id for #findById');
        }
      }).then(function () {
    ...
    value: function findOne(query, callback) {
      ...
      return _bluebird2.default.resolve(Promise.resolve().then(function () {
        if (!query) {
          throw new _errors2.default.data.request.InvalidError('you need to specify a query for #findOne');
        }
      }).then(function () {
        return _this5._verify();
      }).then(function () {
        return _this5._pipeline.findOne(_this5._type, query);
      })).nodeify(callback);
    }
    ...
    value: function remove(query, callback) {
      ...
      return _bluebird2.default.resolve(Promise.resolve().then(function () {
        if (!query) {
          throw new _errors2.default.data.request.InvalidError('you need to specify a query for #remove');
        }
      }).then(function () {
        return _this6._verify();
      }).then(function () {
        return _this6._pipeline.remove(_this6._type, query);
      })).nodeify(callback);
    }
    ...
    value: function removeOneById(id, callback) {
      ...
      return _bluebird2.default.resolve(Promise.resolve().then(function () {
        if (!id) {
          throw new _errors2.default.data.request.InvalidError('you need to specify an id for #removeOneById');
        }
      }).then(function () {
        return _this7._verify();
      }).then(function () {
        return _this7._pipeline.remove(_this7._type, {
          _id: id
        });
      })).nodeify(callback);
    }
    ...
    value: function save(json, callback) {
      ...
      return _bluebird2.default.resolve(this._verify().then(function () {
        return _this8._pipeline.save(_this8._type, json);
      })).nodeify(callback);
    }
  }]);
...
DataAPI.disconnect = function () {
  return _dataPipeline2.default._mongoConnection.close();
};
